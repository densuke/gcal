...
mod tests {
    ...
    fn test_parse_recurrence_daily() {
        let rrule = parse_recurrence(Some("daily"), None, None, None, None, None, today())
            .unwrap()
            .unwrap();
    ...
    fn test_parse_recurrence_weekly() {
        let rrule = parse_recurrence(Some("weekly"), None, None, None, None, None, today())
            .unwrap()
            .unwrap();
    ...
    fn test_parse_recurrence_monthly() {
        let rrule = parse_recurrence(Some("monthly"), None, None, None, None, None, today())
            .unwrap()
            .unwrap();
    ...
    fn test_parse_recurrence_yearly() {
        let rrule = parse_recurrence(Some("yearly"), None, None, None, None, None, today())
            .unwrap()
            .unwrap();
    ...
    fn test_parse_recurrence_weekly_with_interval_and_count() {
        ...
        assert_eq!(
            rrule,
            vec!["RRULE:FREQ=WEEKLY;INTERVAL=2;BYDAY=MO,WE;COUNT=10"]
        );
    }
    ...
    fn test_parse_recurrence_raw_rrule() {
        ...
        let rrule = parse_recurrence(None, None, None, None, None, Some(raw), today())
            .unwrap()
            .unwrap();
        assert_eq!(rrule, vec!["RRULE:FREQ=YEARLY"]);
    }
    ...
    fn test_parse_recurrence_interval_only() {
        let rrule = parse_recurrence(Some("daily"), Some(3), None, None, None, None, today())
            .unwrap()
            .unwrap();
